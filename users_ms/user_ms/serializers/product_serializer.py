...
from user_ms.models.product_model import Product
from user_ms.models.category_model import Category
from user_ms.serializers.category_serializer import CategorySerializer
